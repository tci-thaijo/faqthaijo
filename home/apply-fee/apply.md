...
สำหรับทุกวารสารที่ประสงค์จะเข้าร่วมอบรม ทั้ง**วารสารที่มีระบบ ThaiJO อยู่แล้ว** และ**วารสารที่ยังไม่มีระบบ ThaiJO** สามารถสมัครเข้าร่วมอบรมการใช้งานระบบ ThaiJO ได้ตามรอบที่กำหนด <mark style="color:red;">**(มีค่าใช้จ่าย)**</mark>
...
📌 **หลังจากระบบเปิดใช้งานแล้ว วารสารสามารถดำเนินการได้ ดังนี้**
...
* เข้าสู่ระบบด้วย **Email** และ **Password** (ที่กรอกในแบบฟอร์มขอเปิดระบบ) เพื่อเริ่มต้นการตั้งค่าและใช้งานระบบ
