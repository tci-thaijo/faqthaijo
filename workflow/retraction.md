...
2. สร้างบทความใหม่เพื่อใช้เป็นประกาศการถอดถอน และเผยแพร่ในฉบับปัจจุบันหรือฉบับที่วารสารกำหนด
...
ประกาศการถอดถอน ให้ระบุข้อมูลของบทความที่ถูกถอดถอนให้ครบถ้วน ได้แก่&#x20;
...
* เลขหน้า
* DOI (ถ้ามี)
* เหตุผลในการถอดถอน โดยใช้ถ้อยคำเชิงข้อเท็จจริง เป็นกลาง และหลีกเลี่ยงการกล่าวหา
* เอกสารอ้างอิง (References) ของประกาศการถอดถอน ควรอ้างอิงถึง **บทความที่ถูกถอดถอน** \
  ในกรณีที่เกี่ยวข้องกับการละเมิดจริยธรรมการวิจัยหรือการตีพิมพ์ อาจอ้างอิงเอกสารหรือแนวปฏิบัติที่เกี่ยวข้อง เช่น COPE Retraction Guidelines หรือหลักจริยธรรมการตีพิมพ์ของวารสาร

นอกจากนี้ ควรเชื่อมโยง (Link) ระหว่างประกาศการถอดถอนและบทความที่ถูกถอดถอน รวมทั้งเพิ่มข้อมูลการเชื่อมโยงใน Metadata ของทั้งสองรายการ เพื่อให้ผู้อ่านและระบบสืบค้นสามารถติดตามความสัมพันธ์ระหว่างเอกสารทั้งสองได้อย่างถูกต้อง
