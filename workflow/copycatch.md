...
เมื่อระบบนำบทความไปตรวจความคล้ายเรียบร้อยแล้ว ให้คลิกที่สัญลักษณ์  <mark style="color:blue;">C สีน้ำเงิน</mark> หรือ <mark style="color:red;">C สีแดง</mark> เพื่อดูผลความคล้าย&#x20;
...
1.  **โลโก้ CopyCatch** แสดงแหล่งข้อมูลที่นำไปตรวจ

    🔵 สีน้ำเงิน = ตรวจเทียบกับบทความที่ยังไม่เผยแพร่

    🔴 สีแดง = ตรวจเทียบกับบทความที่เผยแพร่แล้ว
2. **ชื่อไฟล์บทความที่นำมาตรวจ** \
   &#xNAN;_&#xE40;ช่น_ “บทความวิจัย.docx” \
   ซึ่งเป็นไฟล์ Article Text ล่าสุดจากหัว Submission Files หรือ Revision ทั้งนี้ขึ้นอยู่กับสถานะของบทความ
...
4. **เปอร์เซ็นต์ความคล้ายทั้งเอกสาร** \
   ...
   &#xNAN;_&#xE40;ช่น_ 26.31% หมายถึง บทความทั้งเรื่องมีข้อความซ้ำรวมกันคิดเป็น 26.31% ของจำนวนคำทั้งหมด
5. **รายการบทความแหล่งที่พบความคล้าย (ฝั่งขวา)** \
   ...
   &#xNAN;_&#xE15;ัวอย่างการอ่าน_\
   ข้อความสีแดงในบทความ (ฝั่งซ้าย) ซ้ำกับ แหล่งที่พบลำดับที่ 1 คิดเป็น 27.56% (ฝั่งขวา) ของบทความต้นทางเรื่องนั้น

{% hint style="success" %}
## **สรุปง่าย ๆ**

* 26.31% หมายถึง บทความที่นำไปตรวจมีความซ้ำคิดเป็นกี่เปอร์เซ็นต์ของเนื้อหาทั้งหมด
* 27.56%, 2.94%, 2.74% ..... หมายถึง บทความที่นำไปตรวจมีความซ้ำคิดเป็นกี่เปอร์เซ็นต์เมื่อเทียบกับบทความต้นทางแต่ละเรื่อง
{% endhint %}
