...
3. **ข้อความของบทความ (ฝั่งซ้าย)**
   1. ข้อความที่ถูกไฮไลต์สี คือ ส่วนที่ระบบตรวจพบว่ามีความคล้าย
   2. ข้อความไฮไลต์สีเดียวกัน หมายถึง ข้อความในบทความ (ฝั่งซ้าย) ซ้ำกับ แหล่งที่พบหมายเลขเดียวกัน (ฝั่งขวา)
4. **เปอร์เซ็นต์ความคล้ายทั้งเอกสาร** \
   เช่น 26.31%\
   แสดงสัดส่วนจำนวนคำที่ซ้ำทั้งหมด (ไฮไลต์สี) เทียบกับ จำนวนคำทั้งหมดของบทความที่นำไปตรวจ
...
3.  **เปอร์เซ็นต์ความคล้ายกับแหล่งที่พบ (รายแหล่ง)**
    ...
    หมายถึง สัดส่วนจำนวนคำที่ซ้ำ เทียบกับ จำนวนคำทั้งหมดของบทความต้นฉบับแต่ละเรื่อง\
    **วิธีคำนวณ**\
    จำนวนคำที่ซ้ำกับแหล่งนั้น ÷ จำนวนคำทั้งหมดของบทความแหล่งนั้น × 100<br>
