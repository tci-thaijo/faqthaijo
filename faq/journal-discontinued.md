...
### <mark style="color:red;background-color:yellow;">**1. ประกาศการหยุดตีพิมพ์บนเว็บไซต์วารสาร**</mark>
...
### <mark style="color:red;background-color:yellow;">**2. ปิดรับบทความในระบบ ThaiJO**</mark>
...
### <mark style="color:red;background-color:yellow;">**3. แจ้งข้อมูลให้แอดมิน ThaiJO และ TCI ทราบ**</mark> ดังนี้
...
### <mark style="color:red;background-color:yellow;">**4. การเก็บรักษาฉบับย้อนหลังให้เข้าถึงได้**</mark>

* ระบบ ThaiJO ยังคงเปิดข้อมูลให้ผู้อ่านสามารถเข้าถึงฉบับย้อนหลังได้ตามปกติ (Open access) เพื่อประโยชน์ทางวิชาการ

***

### <mark style="color:red;background-color:yellow;">**5. การสำรองข้อมูล (หากต้องการ)**</mark>

* วารสารสำรองข้อมูลโดย **ดาวน์โหลดไฟล์และข้อมูลต่าง ๆ** ของวารสาร เช่น ฉบับย้อนหลัง, รายชื่อผู้แต่ง, Metadata และข้อมูลการส่งบทความ เพื่อ**เก็บไว้ในเครื่องคอมพิวเตอร์ส่วนตัวของวารสาร** เผื่อในอนาคตจำเป็นต้องใช้งาน
